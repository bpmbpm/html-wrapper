## marked
marked.js — это библиотека на JavaScript для преобразования Markdown-текста в HTML.  
...
<head>
    <meta charset="UTF-8">
    <title>Marked.js Пример</title>
    <!-- Подключаем marked.js через CDN -->
    <script src="https://cdn.jsdelivr.net/npm/marked/marked.min.js"></script>
</head>
<body>

    <!-- Исходный Markdown текст -->
    <textarea id="markdown-input" style="width:100%;height:100px;">
# Заголовок
...
* Список 2
    ...
    <script>
        ...
        // Вставляем полученный HTML (вставка в DOM)
...
<body>
    ...
    <script>
        // 1. Markdown-текст
        const markdownText = '# Заголовок\n\nЭто пример текста, обработанного с помощью **marked.js**.';
